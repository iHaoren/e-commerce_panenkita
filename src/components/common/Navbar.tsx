        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {isMenuOpen && (
            <div className="md:hidden pb-4 space-y-3 border-t border-gray-200">
              <a href="#fitur" className="block text-gray-600 hover:text-emerald-600 py-2">Fitur</a>
              <a href="#tentang" className="block text-gray-600 hover:text-emerald-600 py-2">Tentang</a>
              <a href="#kontak" className="block text-gray-600 hover:text-emerald-600 py-2">Kontak</a>
              <button className="w-full px-4 py-2 border-2 border-emerald-600 text-gray-600 rounded-lg font-semibold hover:bg-emerald-600 hover:text-white transition shadow-2xs shadow-gray-600">Login</button>
              <button className="w-full px-4 py-2 bg-emerald-600 text-white rounded-lg font-semibold hover:bg-emerald-800 shadow-2xs shadow-gray-600">Register</button>
            </div>
          )}
        </div>
      </nav>
